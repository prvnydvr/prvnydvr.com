...
export const PERSONAL_INFO = {
  ...
  headline: "Student builder working across Computer Science, product design, and creative technology.",
  shortIntro: "I am a high school student from Lucknow, India, building web products, student tools, 3D experiments, and AI product ideas.",
  chips: [
    "Class 12, PCM and Computer Science",
    "Frontend Developer and 3D Designer",
    "Building student tools"
  ],
  ...
  aboutFull: "I am Praveen Yadav, a Class 12 student from Lucknow, India, focused on Computer Science, frontend development, product design, and 3D design. I like building practical tools, student products, and creative digital experiences. My work includes collaboration platforms, privacy tools, institutional tools, AI product ideas, research writing, and 3D design experiments. I use this portfolio to document what I build, how I think, and what I learn through real projects.",
  academics: {
    currentClass: "Class 12, session 2026 to 2027",
    board: "CBSE",
  ...
  currentlyFocused: [
    ...
    { title: "AI product building", desc: "Exploring how AI and LLM workflows can support useful, privacy aware product ideas." },
    { title: "Student web products", desc: "Designing practical tools and collaboration systems for students and young builders." },
...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    techStack: ["React and Next.js", "Tailwind CSS", "Supabase or Firebase", "TypeScript"],
    impact: "Currently being scoped and built.",
    ...
    caseStudySections: [
      ...
      },
      {
        ...
        content: "The interface is designed to stay direct and low friction, with readable project cards, clear status labels, focused discovery, and simple actions that help students understand what a project needs."
      },
      {
        title: "Build Process",
  ...
  },
  {
    ...
    shortDescription: "An AI powered personal journal and memory app designed to help users save, search, and reflect on memories, screenshots, thoughts, photos, songs, places, and emotional moments.",
    ...
    techStack: ["React and Next.js", "Tailwind CSS", "AI and LLM integration planned", "Privacy focused storage planned"],
    impact: "Currently being scoped and designed.",
  ...
  },
  {
    ...
    year: "2026",
    status: "Live and Built",
    shortDescription: "A temporary clipboard web app for uploading text or images with password protection and automatic expiry after 10 minutes.",
    ...
    caseStudySections: [
      ...
      },
      {
        ...
        content: "The tool is designed around temporary uploads, password protection, and automatic expiry after 10 minutes. The goal is to keep the sharing flow short, clear, and privacy focused."
      },
      {
  ...
  },
  {
    ...
    shortDescription: "An inventory management system designed for school and institutional inventory workflows.",
    ...
    role: "Developer",
    techStack: ["HTML", "CSS", "JavaScript", "Firebase or Supabase if applicable"],
    ...
    caseStudySections: [
      {
        ...
        content: "This project is an inventory management system designed for school or institutional workflows. The public description stays careful and focuses on the workflow, the technical build, and the management problem."
      }
    ]
  },
  {
...
export const BLOG_POSTS_DATA: BlogPost[] = [
  {
    ...
    readingTime: "",
    content: "Notes on building a student collaboration platform for high school students."
  },
  {
    ...
    date: "2026",
    excerpt: "Notes on designing a personal memory app that combines journaling, screenshots, photos, emotional search, and AI reflection.",
    readingTime: "",
    content: "Notes on designing a personal memory app that combines journaling, screenshots, photos, emotional search, and AI reflection."
  },
  {
    ...
    readingTime: "",
    content: "A short reflection on building a temporary, privacy focused sharing tool."
  },
  {
    ...
    readingTime: "",
    content: "Thoughts on making simple, useful, and accessible student tools."
  },
  {
    ...
    readingTime: "",
    content: "How I learn by building projects and improving through iteration."
  },
  {
    ...
    readingTime: "",
    content: "Research notes on how social media affects youth, education, and opportunity in rural India."
  }
];
...
export const THREED_DATA: ThreeDItem[] = [
  ...
  {
    id: "3d-4",
    title: "Environment Design Study",
  ...
  {
    id: "3d-5",
    title: "Creative Technology Study",
...
export const SKILL_GROUPS: SkillGroup[] = [
  ...
  {
    category: "Backend and Database Skills",
  ...
  },
  {
    ...
    skills: ["UI and UX design", "Landing page design", "Product design", "3D design", "Blender", "Visual systems"]
  },
  {
...
export const RESUME_TIMELINE = [
  {
    ...
    title: "Class 12 Student, PCM and Computer Science",
  ...
  {
    period: "2026 to Present",
    title: "Founder and Product Designer",
  ...
  },
  {
    ...
    description: "Built an inventory management system designed for school and institutional inventory workflows."
  },
  {
